-- Corrige a RPC de retificação de Etapa para a assinatura usada pelo frontend.
-- Remove a sobrecarga antiga sem p_dependencias e mantém a meta da Etapa como
-- referência gerencial, sem bloqueá-la pelo total planejado das OPs.

BEGIN;

DROP FUNCTION IF EXISTS public.retificar_etapa_producao(
  UUID, TEXT, TEXT, TEXT, TEXT, TEXT, NUMERIC, DATE, DATE, TEXT,
  INTEGER, NUMERIC, NUMERIC, BOOLEAN, TEXT
);
