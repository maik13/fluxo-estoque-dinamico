...
create policy "items_write_all_auth" on public.items for insert to authenticated with check (true);

drop policy if exists "items_update_all_auth" on public.items;
create policy "items_update_all_auth" on public.items for update to authenticated using (true) with check (true);

drop policy if exists "items_delete_all_auth" on public.items;
create policy "items_delete_all_auth" on public.items for delete to authenticated using (true);

-- Movements policies
drop policy if exists "movements_read_all_auth" on public.movements;
create policy "movements_read_all_auth" on public.movements for select to authenticated using (true);

drop policy if exists "movements_write_all_auth" on public.movements;
create policy "movements_write_all_auth" on public.movements for insert to authenticated with check (true);

drop policy if exists "movements_update_all_auth" on public.movements;
create policy "movements_update_all_auth" on public.movements for update to authenticated using (true) with check (true);

drop policy if exists "movements_delete_all_auth" on public.movements;
create policy "movements_delete_all_auth" on public.movements for delete to authenticated using (true);
