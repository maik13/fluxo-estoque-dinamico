...
DECLARE
  ...
  v_pode_ver_custos BOOLEAN := FALSE;
BEGIN
  IF v_user IS NOT NULL THEN
    v_pode_ver := public.is_admin()
      OR COALESCE(public.permissao_individual_efetiva(v_user, 'pode_ver_bi_producao'), FALSE)
