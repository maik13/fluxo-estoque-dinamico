...
-- 1. Remove the master user auto-promotion trigger to eliminate hardcoded backdoor
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;
DROP FUNCTION IF EXISTS public.handle_master_user();
...
-- 5. Create a view for safe user listing that doesn't expose sensitive data unnecessarily
