-- Permite emitir quantas Ordens de Produção forem necessárias dentro de uma Etapa aberta.
-- A quantidade planejada da Etapa passa a ser uma meta gerencial, não um teto de emissão.
...
COMMENT ON FUNCTION public.criar_ordem_producao(
  UUID, NUMERIC, DATE, DATE, TEXT, UUID, TEXT, INTEGER, TEXT, TEXT, TEXT
) IS 'Emite OP em Etapa aberta sem limitar a soma das quantidades das OPs pela meta referencial da Etapa.';
