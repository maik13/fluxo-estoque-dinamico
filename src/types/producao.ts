...
export type ProducaoLocalOperacionalTipo = 'processamento' | 'fabrica' | 'estoque' | 'logistica' | 'execucao' | 'manutencao' | 'outro';
...
export interface ProducaoProjetoLocal {
  id: string; projeto_id: string; local_utilizacao_id: string | null; nome: string; tipo: ProducaoLocalOperacionalTipo;
  cidade: string | null; uf: string | null; endereco: string | null; principal: boolean; ativo: boolean;
  created_at: string; updated_at: string;
}
export interface ProducaoProjeto {
  id: string; config_id: string | null; local_utilizacao_id: string | null; group_id: string | null; grupo_nome: string | null;
  ...
  created_at: string; updated_at: string; locais: ProducaoProjetoLocal[];
}
...
export interface ProducaoProcessoLocalResumo { id: string; nome: string; tipo: ProducaoLocalOperacionalTipo; cidade: string | null; uf: string | null; }
export interface ProducaoProcesso {
  id: string; codigo: string; projeto_id: string; projeto_local_id: string | null; nome: string; descricao: string | null; produto_entregavel: string | null;
  ...
  created_at: string; updated_at: string; projeto?: ProducaoProcessoProjetoResumo | null; local_operacional?: ProducaoProcessoLocalResumo | null;
}
...
export interface ProducaoApontamento {
  id: string; data: string; projeto_local_id: string | null; projeto_id: string | null; projeto_local_operacional_id: string | null;
  processo_id: string | null; tarefa_id: string; local_tipo: ProducaoLocalTipo;
  ...
  created_at: string; updated_at: string;
  processo?: (Pick<ProducaoProcesso, 'id' | 'codigo' | 'nome'> & { projeto?: ProducaoProcessoProjetoResumo | null; local_operacional?: ProducaoProcessoLocalResumo | null }) | null;
}
...
export interface NovoApontamentoProducao {
  data: string; projeto_id?: string | null; projeto_local_operacional_id?: string | null; projeto_local_id?: string | null; processo_id?: string | null;
  tarefa_id: string; local_tipo: ProducaoLocalTipo; quantidade_produzida?: number | null; inicio: string; termino: string;
  minutos_produtivos?: number | null; minutos_improdutivos?: number | null; motivo_improdutivo?: string | null; observacoes?: string | null; membros_ids: string[];
}
export interface FiltrosProducao { data_inicio?: string; data_fim?: string; projeto_id?: string; projeto_local_operacional_id?: string; projeto_local_id?: string; processo_id?: string; tarefa_id?: string; status?: ProducaoStatus; local_tipo?: ProducaoLocalTipo; }
...
export interface ResumoCustosProducao { horas_relogio: number; horas_homem: number; minutos_produtivos: number; minutos_improdutivos: number; horas_produtivas: number; horas_improdutivas: number; eficiencia_percentual: number; custo_total: number | null; custo_produtivo: number | null; custo_improdutivo: number | null; custo_incompleto: boolean; membros_sem_valor_hora: string[]; }
export interface IndicadorProducaoPorProjeto { projeto_local_id: string; projeto_nome: string; total_apontamentos: number; total_minutos: number; total_horas: number; horas_homem: number; horas_produtivas: number; horas_improdutivas: number; eficiencia_percentual: number; custo_total: number | null; custo_produtivo: number | null; custo_improdutivo: number | null; custo_incompleto: boolean; quantidade_fotos: number; quantidade_total_produzida: number; total_membros_distintos: number; status_predominante: ProducaoStatus | null; distribuicao_status: DistribuicaoStatusProducao; }
export interface IndicadorProducaoPorTarefa { tarefa_id: string; tarefa_nome: string; categoria: string | null; total_apontamentos: number; total_minutos: number; total_horas: number; horas_homem: number; horas_produtivas: number; horas_improdutivas: number; eficiencia_percentual: number; custo_total: number | null; custo_produtivo: number | null; custo_improdutivo: number | null; custo_incompleto: boolean; quantidade_total_produzida: number; }
export interface IndicadorProducaoPorMembro { membro_id: string; membro_nome: string; total_apontamentos: number; total_minutos: number; total_horas: number; horas_produtivas: number; horas_improdutivas: number; eficiencia_percentual: number; custo_total: number | null; custo_produtivo: number | null; custo_improdutivo: number | null; custo_incompleto: boolean; valor_hora_minimo: number | null; valor_hora_maximo: number | null; projetos_distintos: number; tarefas_distintas: number; }
