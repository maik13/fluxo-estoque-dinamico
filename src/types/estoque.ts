...
export interface Item {
  ...
  imobilizado?: boolean; // Classificação patrimonial calculada no banco
...
export interface Movimentacao {
  ...
  tipoOperacaoId?: string; // ID do tipo de operação da movimentação
  tipoOperacaoNome?: string; // Nome do tipo de operação da movimentação
