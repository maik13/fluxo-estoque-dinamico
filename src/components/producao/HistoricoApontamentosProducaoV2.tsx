...
import { CheckCircle2, Eye, Filter, XCircle } from 'lucide-react';
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Consulte o contexto do apontamento e identifique quem realizou cada ação.</CardDescription>
      </CardHeader>
      <CardContent className="space-y-5">
        ...
        <div className="overflow-x-auto rounded-lg border">
          <Table>
            ...
            <TableBody>
              {loading ? (
                <TableRow><TableCell colSpan={8} className="h-28 text-center">Carregando...</TableCell></TableRow>
              ) : filtrados.length === 0 ? (
                <TableRow><TableCell colSpan={8} className="h-28 text-center text-muted-foreground">Nenhum apontamento encontrado.</TableCell></TableRow>
