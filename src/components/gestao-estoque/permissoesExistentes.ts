...
export const PERMISSOES_EXISTENTES: PermissaoExistenteDefinicao[] = [
  ...
  ['pode_solicitar_material','estoque.solicitacoes.solicitar','Estoque','Movimentações','Solicitar material','Permite criar solicitações de materiais.',50],
  ['pode_devolver_material','estoque.solicitacoes.devolver','Estoque','Movimentações','Devolver material','Permite registrar devoluções de materiais.',60],
  ...
  ['pode_registrar_saida','estoque.movimentacoes.saida','Estoque','Movimentações','Registrar saída','Permite registrar saídas de materiais.',80],
  ...
  ['pode_solicitacao_material','estoque.solicitacoes.gerenciar','Estoque','Solicitações e Compras','Gerenciar solicitações','Permite consultar e gerenciar solicitações.',110],
