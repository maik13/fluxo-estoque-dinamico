...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center gap-1 rounded-xl border border-border bg-muted p-1",
      "shadow-[inset_0_1px_3px_hsl(var(--foreground)_/_0.08)]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "transition-all duration-200 ease-out ring-offset-background",
      ...
      "data-[state=active]:shadow-[0_0_0_1px_hsl(var(--primary)_/_0.08),0_2px_8px_hsl(var(--primary)_/_0.10)]",
      className
    )}
    {...props}
  />
